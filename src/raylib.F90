...
! Licence: ISC
module raylib
    !! A collection of auto-generated Fortran 2018 interface bindings to raylib 6.0.
    use, intrinsic :: iso_c_binding, only: c_associated, c_f_pointer, c_funloc, c_loc, c_sizeof, &
                                           ...
                                           c_long, c_ptr, c_signed_char, c_size_t, &
    ...
    type, bind(c), public :: matrix_type
        real(c_float) :: m0 = 0.0, m4 = 0.0,  m8 = 0.0, m12 = 0.0
        real(c_float) :: m1 = 0.0, m5 = 0.0,  m9 = 0.0, m13 = 0.0
        real(c_float) :: m2 = 0.0, m6 = 0.0, m10 = 0.0, m14 = 0.0
        real(c_float) :: m3 = 0.0, m7 = 0.0, m11 = 0.0, m15 = 0.0
    end type matrix_type

    ! Color
    type, bind(c), public :: color_type
        integer(c_unsigned_char) :: r = int(z'00', c_unsigned_char)
        integer(c_unsigned_char) :: g = int(z'00', c_unsigned_char)
        integer(c_unsigned_char) :: b = int(z'00', c_unsigned_char)
        integer(c_unsigned_char) :: a = int(z'FF', c_unsigned_char)
    end type color_type
    ...
    type, bind(c), public :: texture_cubemap_type
        integer(c_unsigned) :: id      = 0_c_unsigned
        integer(c_int)      :: width   = 0
        integer(c_int)      :: height  = 0
        integer(c_int)      :: mipmaps = 0
        integer(c_int)      :: format  = 0
    ...
    type, bind(c), public :: render_texture_type
        integer(c_unsigned)  :: id      = 0_c_unsigned
        type(texture2d_type) :: texture = texture2d_type()
        type(texture2d_type) :: depth   = texture2d_type()
    ...
    type, bind(c), public :: npatch_info_type
        type(rectangle_type) :: source = rectangle_type()
        integer(c_int)       :: left   = 0
        integer(c_int)       :: top    = 0
        integer(c_int)       :: right  = 0
        integer(c_int)       :: bottom = 0
        integer(c_int)       :: layout = 0
    end type npatch_info_type

    ! GlyphInfo
    type, bind(c), public :: glyph_info_type
        integer(c_int)   :: value     = 0
        integer(c_int)   :: offset_x  = 0
        integer(c_int)   :: offset_y  = 0
        integer(c_int)   :: advance_x = 0
        type(image_type) :: image     = image_type()
    end type glyph_info_type

    ! Font
    type, bind(c), public :: font_type
        integer(c_int)       :: base_size     = 0
        integer(c_int)       :: glyph_count   = 0
        integer(c_int)       :: glyph_padding = 0
        type(texture2d_type) :: texture       = texture2d_type()
    ...
    type, bind(c), public :: camera3d_type
        ...
        type(vector3_type) :: up         = vector3_type()
        real(c_float)      :: fov_y      = 0.0
        integer(c_int)     :: projection = 0
    end type camera3d_type

    ! Camera2D
    type, bind(c), public :: camera2d_type
        type(vector2_type) :: offset   = vector2_type()
        type(vector2_type) :: target   = vector2_type()
        real(c_float)      :: rotation = 0.0
        real(c_float)      :: zoom     = 0.0
    end type camera2d_type

    ! Mesh
    type, bind(c), public :: mesh_type
        integer(c_int)      :: vertex_count    = 0
        integer(c_int)      :: triangle_count  = 0
        ...
        integer(c_int)      :: bone_count      = 0
        integer(c_unsigned) :: vao_id          = 0_c_unsigned
    ...
    type, bind(c), public :: material_map_type
        ...
        real(c_float)        :: value   = 0.0
    end type material_map_type

    ! Material
    type, bind(c), public :: material_type
        type(shader_type)  :: shader      = shader_type()
        type(c_ptr)        :: maps        = c_null_ptr !! MaterialMap * (MAX_MATERIAL_MAPS)
        real(c_float)      :: params(0:3) = 0.0
    end type material_type

    ! Transform
    type, bind(c), public :: transform_type
        type(vector3_type)    :: translation = vector3_type()
        type(quaternion_type) :: rotation    = quaternion_type()
        type(vector3_type)    :: scale       = vector3_type()
    end type transform_type

    ! BoneInfo
    type, bind(c), public :: bone_info_type
        character(c_char) :: name(0:31) = c_null_char
        integer(c_int)    :: parent     = 0
    end type bone_info_type

    ! Model
    type, bind(c), public :: model_type
        type(matrix_type) :: transform      = matrix_type()
        integer(c_int)    :: mesh_count     = 0
        integer(c_int)    :: material_count = 0
    ...
    type, bind(c), public :: ray_type
        type(vector3_type) :: position  = vector3_type()
        type(vector3_type) :: direction = vector3_type()
    end type ray_type

    ! RayCollision
    type, bind(c), public :: ray_collision_type
        logical(c_bool)    :: hit      = .false._c_bool
        real(c_float)      :: distance = 0.0
        type(vector3_type) :: point    = vector3_type()
        type(vector3_type) :: normal   = vector3_type()
    end type ray_collision_type

    ! BoundingBox
    type, bind(c), public :: bounding_box_type
        type(vector3_type) :: min = vector3_type()
        type(vector3_type) :: max = vector3_type()
    end type bounding_box_type

    ! Wave
    type, bind(c), public :: wave_type
        integer(c_unsigned) :: frame_count = 0_c_unsigned
        integer(c_unsigned) :: sample_rate = 0_c_unsigned
        integer(c_unsigned) :: sample_size = 0_c_unsigned
        integer(c_unsigned) :: channels    = 0_c_unsigned
        type(c_ptr)         :: data        = c_null_ptr !! void *
    end type wave_type
    ...
    type, bind(c), public :: sound_type
        type(audio_stream_type) :: stream      = audio_stream_type()
        integer(c_unsigned)     :: frame_count = 0
    end type sound_type
    ...
    type, bind(c), public :: music_type
        ...
        integer(c_unsigned) :: frame_count = 0_c_unsigned
        logical(c_bool)     :: looping     = .false._c_bool
        integer(c_int)      :: ctx_type    = 0
        type(c_ptr)         :: ctx_data    = c_null_ptr !! void *
    end type music_type

    ! VrDeviceInfo
    type, bind(c), public :: vr_device_info_type
        integer(c_int) :: h_resolution                = 0
        integer(c_int) :: v_resolution                = 0
        real(c_float)  :: h_screen_size               = 0.0
        real(c_float)  :: v_screen_size               = 0.0
        real(c_float)  :: v_screen_center             = 0.0
        real(c_float)  :: eye_to_screen_distance      = 0.0
        real(c_float)  :: lens_separation_distance    = 0.0
        real(c_float)  :: interpupillary_distance     = 0.0
        real(c_float)  :: lens_distortion_values(0:3) = 0.0
        real(c_float)  :: chroma_ab_correction(0:3)   = 0.0
    end type vr_device_info_type

    ! VrStereoConfig
    type, bind(c), public :: vr_stereo_config_type
        type(matrix_type) :: projection(0:1)          = matrix_type()
        type(matrix_type) :: view_offset(0:1)         = matrix_type()
        real(c_float)     :: left_lens_center(0:1)    = 0.0
        real(c_float)     :: right_lens_center(0:1)   = 0.0
        real(c_float)     :: left_screen_center(0:1)  = 0.0
        real(c_float)     :: right_screen_center(0:1) = 0.0
        real(c_float)     :: scale(0:1)               = 0.0
        real(c_float)     :: scale_in(0:1)            = 0.0
    end type vr_stereo_config_type

    ! FilePathList
    type, bind(c), public :: file_path_list_type
        integer(c_unsigned) :: capacity = 0_c_unsigned
        integer(c_unsigned) :: count    = 0_c_unsigned
    ...
    ! ConfigFlags
    integer(c_int), parameter, public :: FLAG_VSYNC_HINT               = int(z'00000040')
    integer(c_int), parameter, public :: FLAG_FULLSCREEN_MODE          = int(z'00000002')
    integer(c_int), parameter, public :: FLAG_WINDOW_RESIZABLE         = int(z'00000004')
    integer(c_int), parameter, public :: FLAG_WINDOW_UNDECORATED       = int(z'00000008')
    integer(c_int), parameter, public :: FLAG_WINDOW_HIDDEN            = int(z'00000080')
    integer(c_int), parameter, public :: FLAG_WINDOW_MINIMIZED         = int(z'00000200')
    integer(c_int), parameter, public :: FLAG_WINDOW_MAXIMIZED         = int(z'00000400')
    integer(c_int), parameter, public :: FLAG_WINDOW_UNFOCUSED         = int(z'00000800')
    integer(c_int), parameter, public :: FLAG_WINDOW_TOPMOST           = int(z'00001000')
    integer(c_int), parameter, public :: FLAG_WINDOW_ALWAYS_RUN        = int(z'00000100')
    integer(c_int), parameter, public :: FLAG_WINDOW_TRANSPARENT       = int(z'00000010')
    integer(c_int), parameter, public :: FLAG_WINDOW_HIGHDPI           = int(z'00002000')
    integer(c_int), parameter, public :: FLAG_WINDOW_MOUSE_PASSTHROUGH = int(z'00004000')
    integer(c_int), parameter, public :: FLAG_BORDERLESS_WINDOWED_MODE = int(z'00008000')
    integer(c_int), parameter, public :: FLAG_MSAA_4X_HINT             = int(z'00000020')
    integer(c_int), parameter, public :: FLAG_INTERLACED_HINT          = int(z'00010000')

    ! TraceLogLevel
    integer(c_int), parameter, public :: LOG_ALL     = 0
    integer(c_int), parameter, public :: LOG_TRACE   = 1
    integer(c_int), parameter, public :: LOG_DEBUG   = 2
    integer(c_int), parameter, public :: LOG_INFO    = 3
    integer(c_int), parameter, public :: LOG_WARNING = 4
    integer(c_int), parameter, public :: LOG_ERROR   = 5
    integer(c_int), parameter, public :: LOG_FATAL   = 6
    integer(c_int), parameter, public :: LOG_NONE    = 7

    ! KeyboardKey
    integer(c_int), parameter, public :: KEY_NULL          = 0
    integer(c_int), parameter, public :: KEY_APOSTROPHE    = 39
    integer(c_int), parameter, public :: KEY_COMMA         = 44
    integer(c_int), parameter, public :: KEY_MINUS         = 45
    integer(c_int), parameter, public :: KEY_PERIOD        = 46
    integer(c_int), parameter, public :: KEY_SLASH         = 47
    integer(c_int), parameter, public :: KEY_ZERO          = 48
    integer(c_int), parameter, public :: KEY_ONE           = 49
    integer(c_int), parameter, public :: KEY_TWO           = 50
    integer(c_int), parameter, public :: KEY_THREE         = 51
    integer(c_int), parameter, public :: KEY_FOUR          = 52
    integer(c_int), parameter, public :: KEY_FIVE          = 53
    integer(c_int), parameter, public :: KEY_SIX           = 54
    integer(c_int), parameter, public :: KEY_SEVEN         = 55
    integer(c_int), parameter, public :: KEY_EIGHT         = 56
    integer(c_int), parameter, public :: KEY_NINE          = 57
    integer(c_int), parameter, public :: KEY_SEMICOLON     = 59
    integer(c_int), parameter, public :: KEY_EQUAL         = 61
    integer(c_int), parameter, public :: KEY_A             = 65
    integer(c_int), parameter, public :: KEY_B             = 66
    integer(c_int), parameter, public :: KEY_C             = 67
    integer(c_int), parameter, public :: KEY_D             = 68
    integer(c_int), parameter, public :: KEY_E             = 69
    integer(c_int), parameter, public :: KEY_F             = 70
    integer(c_int), parameter, public :: KEY_G             = 71
    integer(c_int), parameter, public :: KEY_H             = 72
    integer(c_int), parameter, public :: KEY_I             = 73
    integer(c_int), parameter, public :: KEY_J             = 74
    integer(c_int), parameter, public :: KEY_K             = 75
    integer(c_int), parameter, public :: KEY_L             = 76
    integer(c_int), parameter, public :: KEY_M             = 77
    integer(c_int), parameter, public :: KEY_N             = 78
    integer(c_int), parameter, public :: KEY_O             = 79
    integer(c_int), parameter, public :: KEY_P             = 80
    integer(c_int), parameter, public :: KEY_Q             = 81
    integer(c_int), parameter, public :: KEY_R             = 82
    integer(c_int), parameter, public :: KEY_S             = 83
    integer(c_int), parameter, public :: KEY_T             = 84
    integer(c_int), parameter, public :: KEY_U             = 85
    integer(c_int), parameter, public :: KEY_V             = 86
    integer(c_int), parameter, public :: KEY_W             = 87
    integer(c_int), parameter, public :: KEY_X             = 88
    integer(c_int), parameter, public :: KEY_Y             = 89
    integer(c_int), parameter, public :: KEY_Z             = 90
    integer(c_int), parameter, public :: KEY_LEFT_BRACKET  = 91
    integer(c_int), parameter, public :: KEY_BACKSLASH     = 92
    integer(c_int), parameter, public :: KEY_RIGHT_BRACKET = 93
    integer(c_int), parameter, public :: KEY_GRAVE         = 96
    integer(c_int), parameter, public :: KEY_SPACE         = 32
    integer(c_int), parameter, public :: KEY_ESCAPE        = 256
    integer(c_int), parameter, public :: KEY_ENTER         = 257
    integer(c_int), parameter, public :: KEY_TAB           = 258
    integer(c_int), parameter, public :: KEY_BACKSPACE     = 259
    integer(c_int), parameter, public :: KEY_INSERT        = 260
    integer(c_int), parameter, public :: KEY_DELETE        = 261
    integer(c_int), parameter, public :: KEY_RIGHT         = 262
    integer(c_int), parameter, public :: KEY_LEFT          = 263
    integer(c_int), parameter, public :: KEY_DOWN          = 264
    integer(c_int), parameter, public :: KEY_UP            = 265
    integer(c_int), parameter, public :: KEY_PAGE_UP       = 266
    integer(c_int), parameter, public :: KEY_PAGE_DOWN     = 267
    integer(c_int), parameter, public :: KEY_HOME          = 268
    integer(c_int), parameter, public :: KEY_END           = 269
    integer(c_int), parameter, public :: KEY_CAPS_LOCK     = 280
    integer(c_int), parameter, public :: KEY_SCROLL_LOCK   = 281
    integer(c_int), parameter, public :: KEY_NUM_LOCK      = 282
    integer(c_int), parameter, public :: KEY_PRINT_SCREEN  = 283
    integer(c_int), parameter, public :: KEY_PAUSE         = 284
    integer(c_int), parameter, public :: KEY_F1            = 290
    integer(c_int), parameter, public :: KEY_F2            = 291
    integer(c_int), parameter, public :: KEY_F3            = 292
    integer(c_int), parameter, public :: KEY_F4            = 293
    integer(c_int), parameter, public :: KEY_F5            = 294
    integer(c_int), parameter, public :: KEY_F6            = 295
    integer(c_int), parameter, public :: KEY_F7            = 296
    integer(c_int), parameter, public :: KEY_F8            = 297
    integer(c_int), parameter, public :: KEY_F9            = 298
    integer(c_int), parameter, public :: KEY_F10           = 299
    integer(c_int), parameter, public :: KEY_F11           = 300
    integer(c_int), parameter, public :: KEY_F12           = 301
    integer(c_int), parameter, public :: KEY_LEFT_SHIFT    = 340
    integer(c_int), parameter, public :: KEY_LEFT_CONTROL  = 341
    integer(c_int), parameter, public :: KEY_LEFT_ALT      = 342
    integer(c_int), parameter, public :: KEY_LEFT_SUPER    = 343
    integer(c_int), parameter, public :: KEY_RIGHT_SHIFT   = 344
    integer(c_int), parameter, public :: KEY_RIGHT_CONTROL = 345
    integer(c_int), parameter, public :: KEY_RIGHT_ALT     = 346
    integer(c_int), parameter, public :: KEY_RIGHT_SUPER   = 347
    integer(c_int), parameter, public :: KEY_KB_MENU       = 348
    integer(c_int), parameter, public :: KEY_KP_0          = 320
    integer(c_int), parameter, public :: KEY_KP_1          = 321
    integer(c_int), parameter, public :: KEY_KP_2          = 322
    integer(c_int), parameter, public :: KEY_KP_3          = 323
    integer(c_int), parameter, public :: KEY_KP_4          = 324
    integer(c_int), parameter, public :: KEY_KP_5          = 325
    integer(c_int), parameter, public :: KEY_KP_6          = 326
    integer(c_int), parameter, public :: KEY_KP_7          = 327
    integer(c_int), parameter, public :: KEY_KP_8          = 328
    integer(c_int), parameter, public :: KEY_KP_9          = 329
    integer(c_int), parameter, public :: KEY_KP_DECIMAL    = 330
    integer(c_int), parameter, public :: KEY_KP_DIVIDE     = 331
    integer(c_int), parameter, public :: KEY_KP_MULTIPLY   = 332
    integer(c_int), parameter, public :: KEY_KP_SUBTRACT   = 333
    integer(c_int), parameter, public :: KEY_KP_ADD        = 334
    integer(c_int), parameter, public :: KEY_KP_ENTER      = 335
    integer(c_int), parameter, public :: KEY_KP_EQUAL      = 336
    integer(c_int), parameter, public :: KEY_BACK          = 4
    integer(c_int), parameter, public :: KEY_MENU          = 82
    integer(c_int), parameter, public :: KEY_VOLUME_UP     = 24
    integer(c_int), parameter, public :: KEY_VOLUME_DOWN   = 25

    ! MouseButton
    integer(c_int), parameter, public :: MOUSE_BUTTON_LEFT    = 0
    integer(c_int), parameter, public :: MOUSE_BUTTON_RIGHT   = 1
    integer(c_int), parameter, public :: MOUSE_BUTTON_MIDDLE  = 2
    integer(c_int), parameter, public :: MOUSE_BUTTON_SIDE    = 3
    integer(c_int), parameter, public :: MOUSE_BUTTON_EXTRA   = 4
    integer(c_int), parameter, public :: MOUSE_BUTTON_FORWARD = 5
    integer(c_int), parameter, public :: MOUSE_BUTTON_BACK    = 6

    ! MouseCursor
    integer(c_int), parameter, public :: MOUSE_CURSOR_DEFAULT       = 0
    integer(c_int), parameter, public :: MOUSE_CURSOR_ARROW         = 1
    integer(c_int), parameter, public :: MOUSE_CURSOR_IBEAM         = 2
    integer(c_int), parameter, public :: MOUSE_CURSOR_CROSSHAIR     = 3
    integer(c_int), parameter, public :: MOUSE_CURSOR_POINTING_HAND = 4
    integer(c_int), parameter, public :: MOUSE_CURSOR_RESIZE_EW     = 5
    integer(c_int), parameter, public :: MOUSE_CURSOR_RESIZE_NS     = 6
    integer(c_int), parameter, public :: MOUSE_CURSOR_RESIZE_NWSE   = 7
    integer(c_int), parameter, public :: MOUSE_CURSOR_RESIZE_NESW   = 8
    integer(c_int), parameter, public :: MOUSE_CURSOR_RESIZE_ALL    = 9
    integer(c_int), parameter, public :: MOUSE_CURSOR_NOT_ALLOWED   = 10

    ! GamepadButton
    integer(c_int), parameter, public :: GAMEPAD_BUTTON_UNKNOWN          = 0
    integer(c_int), parameter, public :: GAMEPAD_BUTTON_LEFT_FACE_UP     = 1
    integer(c_int), parameter, public :: GAMEPAD_BUTTON_LEFT_FACE_RIGHT  = 2
    integer(c_int), parameter, public :: GAMEPAD_BUTTON_LEFT_FACE_DOWN   = 3
    integer(c_int), parameter, public :: GAMEPAD_BUTTON_LEFT_FACE_LEFT   = 4
    integer(c_int), parameter, public :: GAMEPAD_BUTTON_RIGHT_FACE_UP    = 5
    integer(c_int), parameter, public :: GAMEPAD_BUTTON_RIGHT_FACE_RIGHT = 6
    integer(c_int), parameter, public :: GAMEPAD_BUTTON_RIGHT_FACE_DOWN  = 7
    integer(c_int), parameter, public :: GAMEPAD_BUTTON_RIGHT_FACE_LEFT  = 8
    integer(c_int), parameter, public :: GAMEPAD_BUTTON_LEFT_TRIGGER_1   = 9
    integer(c_int), parameter, public :: GAMEPAD_BUTTON_LEFT_TRIGGER_2   = 10
    integer(c_int), parameter, public :: GAMEPAD_BUTTON_RIGHT_TRIGGER_1  = 11
    integer(c_int), parameter, public :: GAMEPAD_BUTTON_RIGHT_TRIGGER_2  = 12
    integer(c_int), parameter, public :: GAMEPAD_BUTTON_MIDDLE_LEFT      = 13
    integer(c_int), parameter, public :: GAMEPAD_BUTTON_MIDDLE           = 14
    integer(c_int), parameter, public :: GAMEPAD_BUTTON_MIDDLE_RIGHT     = 15
    integer(c_int), parameter, public :: GAMEPAD_BUTTON_LEFT_THUMB       = 16
    integer(c_int), parameter, public :: GAMEPAD_BUTTON_RIGHT_THUMB      = 17

    ! GamepadAxis
    integer(c_int), parameter, public :: GAMEPAD_AXIS_LEFT_X        = 0
    integer(c_int), parameter, public :: GAMEPAD_AXIS_LEFT_Y        = 1
    integer(c_int), parameter, public :: GAMEPAD_AXIS_RIGHT_X       = 2
    integer(c_int), parameter, public :: GAMEPAD_AXIS_RIGHT_Y       = 3
    integer(c_int), parameter, public :: GAMEPAD_AXIS_LEFT_TRIGGER  = 4
    integer(c_int), parameter, public :: GAMEPAD_AXIS_RIGHT_TRIGGER = 5

    ! MaterialMapIndex
    integer(c_int), parameter, public :: MATERIAL_MAP_ALBEDO     = 0
    integer(c_int), parameter, public :: MATERIAL_MAP_METALNESS  = 1
    integer(c_int), parameter, public :: MATERIAL_MAP_NORMAL     = 2
    integer(c_int), parameter, public :: MATERIAL_MAP_ROUGHNESS  = 3
    integer(c_int), parameter, public :: MATERIAL_MAP_OCCLUSION  = 4
    integer(c_int), parameter, public :: MATERIAL_MAP_EMISSION   = 5
    integer(c_int), parameter, public :: MATERIAL_MAP_HEIGHT     = 6
    integer(c_int), parameter, public :: MATERIAL_MAP_CUBEMAP    = 7
    integer(c_int), parameter, public :: MATERIAL_MAP_IRRADIANCE = 8
    integer(c_int), parameter, public :: MATERIAL_MAP_PREFILTER  = 9
    integer(c_int), parameter, public :: MATERIAL_MAP_BRDF       = 10

    integer(c_int), parameter, public :: MATERIAL_MAP_DIFFUSE    = 0
    integer(c_int), parameter, public :: MATERIAL_MAP_SPECULAR   = 1

    ! ShaderLocationIndex
    integer(c_int), parameter, public :: SHADER_LOC_VERTEX_POSITION          =  0
    integer(c_int), parameter, public :: SHADER_LOC_VERTEX_TEXCOORD01        =  1
    integer(c_int), parameter, public :: SHADER_LOC_VERTEX_TEXCOORD02        =  2
    integer(c_int), parameter, public :: SHADER_LOC_VERTEX_NORMAL            =  3
    integer(c_int), parameter, public :: SHADER_LOC_VERTEX_TANGENT           =  4
    integer(c_int), parameter, public :: SHADER_LOC_VERTEX_COLOR             =  5
    integer(c_int), parameter, public :: SHADER_LOC_MATRIX_MVP               =  6
    integer(c_int), parameter, public :: SHADER_LOC_MATRIX_VIEW              =  7
    integer(c_int), parameter, public :: SHADER_LOC_MATRIX_PROJECTION        =  8
    integer(c_int), parameter, public :: SHADER_LOC_MATRIX_MODEL             =  9
    integer(c_int), parameter, public :: SHADER_LOC_MATRIX_NORMAL            = 10
    integer(c_int), parameter, public :: SHADER_LOC_VECTOR_VIEW              = 11
    integer(c_int), parameter, public :: SHADER_LOC_COLOR_DIFFUSE            = 12
    integer(c_int), parameter, public :: SHADER_LOC_COLOR_SPECULAR           = 13
    integer(c_int), parameter, public :: SHADER_LOC_COLOR_AMBIENT            = 14
    integer(c_int), parameter, public :: SHADER_LOC_MAP_ALBEDO               = 15
    integer(c_int), parameter, public :: SHADER_LOC_MAP_METALNESS            = 16
    integer(c_int), parameter, public :: SHADER_LOC_MAP_NORMAL               = 17
    integer(c_int), parameter, public :: SHADER_LOC_MAP_ROUGHNESS            = 18
    integer(c_int), parameter, public :: SHADER_LOC_MAP_OCCLUSION            = 19
    integer(c_int), parameter, public :: SHADER_LOC_MAP_EMISSION             = 20
    integer(c_int), parameter, public :: SHADER_LOC_MAP_HEIGHT               = 21
    integer(c_int), parameter, public :: SHADER_LOC_MAP_CUBEMAP              = 22
    integer(c_int), parameter, public :: SHADER_LOC_MAP_IRRADIANCE           = 23
    integer(c_int), parameter, public :: SHADER_LOC_MAP_PREFILTER            = 24
    integer(c_int), parameter, public :: SHADER_LOC_MAP_BRDF                 = 25
    integer(c_int), parameter, public :: SHADER_LOC_VERTEX_BONEIDS           = 26
    integer(c_int), parameter, public :: SHADER_LOC_VERTEX_BONEWEIGHTS       = 27
    integer(c_int), parameter, public :: SHADER_LOC_MATRIX_BONETRANSFORMS    = 28
    integer(c_int), parameter, public :: SHADER_LOC_VERTEX_INSTANCETRANSFORM = 29

    ! ShaderUniformDataType
    integer(c_int), parameter, public :: SHADER_UNIFORM_FLOAT     = 0
    integer(c_int), parameter, public :: SHADER_UNIFORM_VEC2      = 1
    integer(c_int), parameter, public :: SHADER_UNIFORM_VEC3      = 2
    integer(c_int), parameter, public :: SHADER_UNIFORM_VEC4      = 3
    integer(c_int), parameter, public :: SHADER_UNIFORM_INT       = 4
    integer(c_int), parameter, public :: SHADER_UNIFORM_IVEC2     = 5
    integer(c_int), parameter, public :: SHADER_UNIFORM_IVEC3     = 6
    integer(c_int), parameter, public :: SHADER_UNIFORM_IVEC4     = 7
    integer(c_int), parameter, public :: SHADER_UNIFORM_SAMPLER2D = 8

    ! ShaderAttributeDataType
    integer(c_int), parameter, public :: SHADER_ATTRIB_FLOAT = 0
    integer(c_int), parameter, public :: SHADER_ATTRIB_VEC2  = 1
    integer(c_int), parameter, public :: SHADER_ATTRIB_VEC3  = 2
    integer(c_int), parameter, public :: SHADER_ATTRIB_VEC4  = 3

    ! PixelFormat
    integer(c_int), parameter, public :: PIXELFORMAT_UNCOMPRESSED_GRAYSCALE    = 1
    integer(c_int), parameter, public :: PIXELFORMAT_UNCOMPRESSED_GRAY_ALPHA   = 2
    integer(c_int), parameter, public :: PIXELFORMAT_UNCOMPRESSED_R5G6B5       = 3
    integer(c_int), parameter, public :: PIXELFORMAT_UNCOMPRESSED_R8G8B8       = 4
    integer(c_int), parameter, public :: PIXELFORMAT_UNCOMPRESSED_R5G5B5A1     = 5
    integer(c_int), parameter, public :: PIXELFORMAT_UNCOMPRESSED_R4G4B4A4     = 6
    integer(c_int), parameter, public :: PIXELFORMAT_UNCOMPRESSED_R8G8B8A8     = 7
    integer(c_int), parameter, public :: PIXELFORMAT_UNCOMPRESSED_R32          = 8
    integer(c_int), parameter, public :: PIXELFORMAT_UNCOMPRESSED_R32G32B32    = 9
    integer(c_int), parameter, public :: PIXELFORMAT_UNCOMPRESSED_R32G32B32A32 = 10
    integer(c_int), parameter, public :: PIXELFORMAT_UNCOMPRESSED_R16          = 11
    integer(c_int), parameter, public :: PIXELFORMAT_UNCOMPRESSED_R16G16B16    = 12
    integer(c_int), parameter, public :: PIXELFORMAT_UNCOMPRESSED_R16G16B16A16 = 13
    integer(c_int), parameter, public :: PIXELFORMAT_COMPRESSED_DXT1_RGB       = 14
    integer(c_int), parameter, public :: PIXELFORMAT_COMPRESSED_DXT1_RGBA      = 15
    integer(c_int), parameter, public :: PIXELFORMAT_COMPRESSED_DXT3_RGBA      = 16
    integer(c_int), parameter, public :: PIXELFORMAT_COMPRESSED_DXT5_RGBA      = 17
    integer(c_int), parameter, public :: PIXELFORMAT_COMPRESSED_ETC1_RGB       = 18
    integer(c_int), parameter, public :: PIXELFORMAT_COMPRESSED_ETC2_RGB       = 19
    integer(c_int), parameter, public :: PIXELFORMAT_COMPRESSED_ETC2_EAC_RGBA  = 20
    integer(c_int), parameter, public :: PIXELFORMAT_COMPRESSED_PVRT_RGB       = 21
    integer(c_int), parameter, public :: PIXELFORMAT_COMPRESSED_PVRT_RGBA      = 22
    integer(c_int), parameter, public :: PIXELFORMAT_COMPRESSED_ASTC_4x4_RGBA  = 23
    integer(c_int), parameter, public :: PIXELFORMAT_COMPRESSED_ASTC_8x8_RGBA  = 24

    ! TextureFilter
    integer(c_int), parameter, public :: TEXTURE_FILTER_POINT           = 0
    integer(c_int), parameter, public :: TEXTURE_FILTER_BILINEAR        = 1
    integer(c_int), parameter, public :: TEXTURE_FILTER_TRILINEAR       = 2
    integer(c_int), parameter, public :: TEXTURE_FILTER_ANISOTROPIC_4X  = 3
    integer(c_int), parameter, public :: TEXTURE_FILTER_ANISOTROPIC_8X  = 4
    integer(c_int), parameter, public :: TEXTURE_FILTER_ANISOTROPIC_16X = 5

    ! TextureWrap
    integer(c_int), parameter, public :: TEXTURE_WRAP_REPEAT        = 0
    integer(c_int), parameter, public :: TEXTURE_WRAP_CLAMP         = 1
    integer(c_int), parameter, public :: TEXTURE_WRAP_MIRROR_REPEAT = 2
    integer(c_int), parameter, public :: TEXTURE_WRAP_MIRROR_CLAMP  = 3

    ! CubemapLayout
    integer(c_int), parameter, public :: CUBEMAP_LAYOUT_AUTO_DETECT         = 0
    integer(c_int), parameter, public :: CUBEMAP_LAYOUT_LINE_VERTICAL       = 1
    integer(c_int), parameter, public :: CUBEMAP_LAYOUT_LINE_HORIZONTAL     = 2
    integer(c_int), parameter, public :: CUBEMAP_LAYOUT_CROSS_THREE_BY_FOUR = 3
    integer(c_int), parameter, public :: CUBEMAP_LAYOUT_CROSS_FOUR_BY_THREE = 4
    integer(c_int), parameter, public :: CUBEMAP_LAYOUT_PANORAMA            = 5

    ! FontType
    integer(c_int), parameter, public :: FONT_DEFAULT = 0
    integer(c_int), parameter, public :: FONT_BITMAP  = 1
    integer(c_int), parameter, public :: FONT_SDF     = 2

    ! BlendMode
    integer(c_int), parameter, public :: BLEND_ALPHA             = 0
    integer(c_int), parameter, public :: BLEND_ADDITIVE          = 1
    integer(c_int), parameter, public :: BLEND_MULTIPLIED        = 2
    integer(c_int), parameter, public :: BLEND_ADD_COLORS        = 3
    integer(c_int), parameter, public :: BLEND_SUBTRACT_COLORS   = 4
    integer(c_int), parameter, public :: BLEND_ALPHA_PREMULTIPLY = 5
    integer(c_int), parameter, public :: BLEND_CUSTOM            = 6
    integer(c_int), parameter, public :: BLEND_CUSTOM_SEPARATE   = 7

    ! Gesture
    integer(c_int), parameter, public :: GESTURE_NONE        = 0
    integer(c_int), parameter, public :: GESTURE_TAP         = 1
    integer(c_int), parameter, public :: GESTURE_DOUBLETAP   = 2
    integer(c_int), parameter, public :: GESTURE_HOLD        = 4
    integer(c_int), parameter, public :: GESTURE_DRAG        = 8
    integer(c_int), parameter, public :: GESTURE_SWIPE_RIGHT = 16
    integer(c_int), parameter, public :: GESTURE_SWIPE_LEFT  = 32
    integer(c_int), parameter, public :: GESTURE_SWIPE_UP    = 64
    integer(c_int), parameter, public :: GESTURE_SWIPE_DOWN  = 128
    integer(c_int), parameter, public :: GESTURE_PINCH_IN    = 256
    integer(c_int), parameter, public :: GESTURE_PINCH_OUT   = 512

    ! CameraMode
    integer(c_int), parameter, public :: CAMERA_CUSTOM       = 0
    integer(c_int), parameter, public :: CAMERA_FREE         = 1
    integer(c_int), parameter, public :: CAMERA_ORBITAL      = 2
    integer(c_int), parameter, public :: CAMERA_FIRST_PERSON = 3
    integer(c_int), parameter, public :: CAMERA_THIRD_PERSON = 4

    ! CameraProjection
    integer(c_int), parameter, public :: CAMERA_PERSPECTIVE  = 0
    integer(c_int), parameter, public :: CAMERA_ORTHOGRAPHIC = 1

    ! NPatchLayout
    integer(c_int), parameter, public :: NPATCH_NINE_PATCH             = 0
    ...
    abstract interface
        ...
        function load_file_data_callback(file_name, bytes_read) bind(c)
            ...
            integer(c_unsigned), intent(out)       :: bytes_read
        ...
        function save_file_data_callback(file_name, data, bytes_to_write) bind(c)
            ...
            integer(c_unsigned), intent(in), value :: bytes_to_write
    ...
    public :: draw_ellipse_lines_v
    public :: draw_ellipse_v
    public :: draw_fps
    public :: draw_grid
    public :: draw_line
    public :: draw_line3d
    public :: draw_line_bezier
    public :: draw_line_dashed
    public :: draw_line_ex
    ...
    public :: file_remove
    public :: file_rename
    public :: file_text_find_index
    public :: file_text_replace
    ...
    public :: get_directory_file_count
    public :: get_directory_file_count_ex
    public :: get_directory_path_
    public :: get_file_extension_
    public :: get_file_length
    public :: get_file_mod_time
    public :: get_file_name_
    public :: get_file_name_without_ext_
    ...
    public :: get_prev_directory_path_
    ...
    public :: get_window_scale_dpi
    public :: get_working_directory_
    ...
    public :: measure_text
    public :: measure_text_codepoints
    ...
    public :: text_insert
    public :: text_insert_alloc
    public :: text_is_equal
    public :: text_length
    public :: text_remove_spaces_
    public :: text_replace
    public :: text_replace_alloc
    public :: text_replace_between
    public :: text_replace_between_alloc
    public :: text_split
    public :: text_subtext_
    public :: text_to_camel_
    public :: text_to_float
    public :: text_to_integer
    public :: text_to_lower_
    public :: text_to_pascal_
    public :: text_to_snake_
    public :: text_to_upper_
    ...
    interface
        ...
        function change_directory(dir) bind(c, name='ChangeDirectory')
            ...
            logical(c_bool)               :: change_directory
        ...
        function check_collision_box_sphere(box, center, radius) bind(c, name='CheckCollisionBoxSphere')
            ...
            logical(c_bool)                            :: check_collision_box_sphere
        ...
        function check_collision_boxes(box1, box2) bind(c, name='CheckCollisionBoxes')
            ...
            logical(c_bool)                            :: check_collision_boxes
        ...
        function check_collision_circle_line(center, radius, p1, p2) bind(c, name='CheckCollisionCircleLine')
            ...
            logical(c_bool)                       :: check_collision_circle_line
        ...
        function check_collision_circle_rec(center, radius, rec) bind(c, name='CheckCollisionCircleRec')
            ...
            logical(c_bool)                         :: check_collision_circle_rec
        ...
        function check_collision_circles(center1, radius1, center2, radius2) bind(c, name='CheckCollisionCircles')
            ...
            real(c_float),      intent(in), value :: radius1
            type(vector2_type), intent(in), value :: center2
            real(c_float),      intent(in), value :: radius2
            logical(c_bool)                       :: check_collision_circles
        ...
        function check_collision_lines(start_pos1, end_pos1, start_pos2, end_pos2, collision_point) &
            ...
            logical(c_bool)                       :: check_collision_lines
        ...
        function check_collision_point_circle(point, center, radius) bind(c, name='CheckCollisionPointCircle')
            ...
            type(vector2_type), intent(in), value :: center
            real(c_float),      intent(in), value :: radius
            logical(c_bool)                       :: check_collision_point_circle
        ...
        function check_collision_point_line(point, p1, p2, threshold) bind(c, name='CheckCollisionPointLine')
            ...
            type(vector2_type), intent(in), value :: p1
            type(vector2_type), intent(in), value :: p2
            integer(c_int),     intent(in), value :: threshold
            logical(c_bool)                       :: check_collision_point_line
        ...
        function check_collision_point_poly(point, points, point_count) bind(c, name='CheckCollisionPointPoly')
            ...
            integer(c_int),     intent(in), value :: point_count
            logical(c_bool)                       :: check_collision_point_poly
        ...
        function check_collision_point_rec(point, rec) bind(c, name='CheckCollisionPointRec')
            ...
            type(vector2_type),   intent(in), value :: point
            type(rectangle_type), intent(in), value :: rec
            logical(c_bool)                         :: check_collision_point_rec
        ...
        function check_collision_point_triangle(point, p1, p2, p3) bind(c, name='CheckCollisionPointTriangle')
            ...
            logical(c_bool)                       :: check_collision_point_triangle
        ...
        function check_collision_recs(rec1, rec2) bind(c, name='CheckCollisionRecs')
            ...
            logical(c_bool)                         :: check_collision_recs
        ...
        function check_collision_spheres(center1, radius1, center2, radius2) bind(c, name='CheckCollisionSpheres')
            ...
            real(c_float),      intent(in), value :: radius2
            logical(c_bool)                       :: check_collision_spheres
        ...
        function codepoint_to_utf8_(codepoint, utf8_size) bind(c, name='CodepointToUTF8')
            import :: c_int, c_ptr
            implicit none
            integer(c_int), intent(in), value :: codepoint
            integer(c_int), intent(out)       :: utf8_size
            type(c_ptr)                       :: codepoint_to_utf8_
        end function codepoint_to_utf8_
        ...
        function color_contrast(color, contrast) bind(c, name='ColorContrast')
            ...
            implicit none
            type(color_type), intent(in), value :: color
            real(c_float),    intent(in), value :: contrast
        ...
        function color_from_hsv(hue, saturation, value) bind(c, name='ColorFromHSV')
            import :: c_float, color_type
            implicit none
            real(c_float), intent(in), value :: hue
            real(c_float), intent(in), value :: saturation
        ...
        function compress_data(data, data_size, comp_data_size) bind(c, name='CompressData')
            ...
            integer(c_int),           intent(out)       :: comp_data_size
        ...
        function compute_crc32(data, data_size) bind(c, name='ComputeCRC32')
            ...
            integer(c_int),    intent(in), value :: data_size
            integer(c_unsigned)                  :: compute_crc32
        ...
        function compute_sha256(data, data_size) bind(c, name='ComputeSHA256')
            import :: c_int, c_ptr, c_unsigned_char
            implicit none
            integer(c_unsigned_char), intent(in)        :: data
            integer(c_int),           intent(in), value :: data_size
            type(c_ptr)                                 :: compute_sha256
        end function compute_sha256
        ...
        function decompress_data(comp_data, comp_data_size, data_size) bind(c, name='DecompressData')
            ...
            integer(c_int),           intent(in), value :: comp_data_size
        ...
        function directory_exists(dir_path) bind(c, name='DirectoryExists')
            import :: c_bool, c_char
            implicit none
            character(c_char), intent(in) :: dir_path
            logical(c_bool)               :: directory_exists
        ...
        subroutine draw_capsule(start_pos, end_pos, radius, slices, rings, color) bind(c, name='DrawCapsule')
            ...
            integer(c_int),     intent(in), value :: rings
            type(color_type),   intent(in), value :: color
        ...
        subroutine draw_circle(center_x, center_y, radius, color) bind(c, name='DrawCircle')
            ...
            implicit none
            integer(c_int),   intent(in), value :: center_x
            integer(c_int),   intent(in), value :: center_y
            real(c_float),    intent(in), value :: radius
            type(color_type), intent(in), value :: color
        ...
        subroutine draw_circle3d(center, radius, rotation_axis, rotation_angle, color) bind(c, name='DrawCircle3D')
            ...
            real(c_float),      intent(in), value :: rotation_angle
            type(color_type),   intent(in), value :: color
        end subroutine draw_circle3d

        ! void DrawCircleGradient(Vector2 center, float radius, Color inner, Color outer)
        subroutine draw_circle_gradient(center, radius, inner, outer) bind(c, name='DrawCircleGradient')
        ...
        subroutine draw_circle_sector(center, radius, start_angle, end_angle, segments, color) &
            ...
            type(vector2_type), intent(in), value :: center
            real(c_float),      intent(in), value :: radius
            real(c_float) ,     intent(in), value :: start_angle
            real(c_float),      intent(in), value :: end_angle
            integer(c_int),     intent(in), value :: segments
            type(color_type),   intent(in), value :: color
        ...
        subroutine draw_cylinder(position, radius_top, radius_bottom, height, slices, color) bind(c, name='DrawCylinder')
            ...
            implicit none
            type(vector3_type), intent(in), value :: position
            real(c_float),      intent(in), value :: radius_top
            real(c_float),      intent(in), value :: radius_bottom
            real(c_float),      intent(in), value :: height
            integer(c_int),     intent(in), value :: slices
            type(color_type),   intent(in), value :: color
        ...
        subroutine draw_cylinder_ex(start_pos, end_pos, start_radius, end_radius, sides, color) bind(c, name='DrawCylinderEx')
            ...
            type(vector3_type), intent(in), value :: start_pos
            type(vector3_type), intent(in), value :: end_pos
            real(c_float),      intent(in), value :: start_radius
            real(c_float),      intent(in), value :: end_radius
            integer(c_int),     intent(in), value :: sides
            type(color_type),   intent(in), value :: color
        ...
        subroutine draw_ellipse(center_x, center_y, radius_h, radius_v, color) bind(c, name='DrawEllipse')
            ...
            integer(c_int),   intent(in), value :: center_x
            integer(c_int),   intent(in), value :: center_y
            real(c_float),    intent(in), value :: radius_h
            real(c_float),    intent(in), value :: radius_v
            type(color_type), intent(in), value :: color
        ...
        subroutine draw_ellipse_lines_v(center, radius_h, radius_v, color) bind(c, name='DrawEllipseLinesV')
            import :: c_float, color_type, vector2_type
            implicit none
            type(vector2_type), intent(in), value :: center
            real(c_float),      intent(in), value :: radius_h
            real(c_float),      intent(in), value :: radius_v
            type(color_type),   intent(in), value :: color
        end subroutine draw_ellipse_lines_v

        ! void DrawEllipseV(Vector2 center, float radiusH, float radiusV, Color color)
        subroutine draw_ellipse_v(center, radius_h, radius_v, color) bind(c, name='DrawEllipseV')
            import :: c_float, color_type, vector2_type
            implicit none
            type(vector2_type), intent(in), value :: center
            real(c_float),      intent(in), value :: radius_h
            real(c_float),      intent(in), value :: radius_v
            type(color_type),   intent(in), value :: color
        end subroutine draw_ellipse_v

        ! void DrawFPS(int posX, int posY)
        subroutine draw_fps(pos_x, pos_y) bind(c, name='DrawFPS')
            import :: c_int
            implicit none
            integer(c_int), intent(in), value :: pos_x
            integer(c_int), intent(in), value :: pos_y
        ...
        subroutine draw_line(start_pos_x, start_pos_y, end_pos_x, end_pos_y, color) bind(c, name='DrawLine')
            import :: c_int, color_type
            implicit none
            integer(c_int),   intent(in), value :: start_pos_x
            integer(c_int),   intent(in), value :: start_pos_y
            integer(c_int),   intent(in), value :: end_pos_x
            integer(c_int),   intent(in), value :: end_pos_y
            type(color_type), intent(in), value :: color
        ...
        subroutine draw_line_bezier(start_pos, end_pos, thick, color) bind(c, name='DrawLineBezier')
            ...
            real(c_float),      intent(in), value :: thick
            type(color_type),   intent(in), value :: color
        ...
        subroutine draw_line_dashed(start_pos, end_pos, dash_size, space_size, color) bind(c, name='DrawLineDashed')
            import :: c_int, color_type, vector2_type
            implicit none
            type(vector2_type), intent(in), value :: start_pos
            type(vector2_type), intent(in), value :: end_pos
            integer(c_int),     intent(in), value :: dash_size
            integer(c_int),     intent(in), value :: space_size
            type(color_type),   intent(in), value :: color
        end subroutine draw_line_dashed
        ...
        subroutine draw_mesh_instanced(mesh, material, transforms, instances) bind(c, name='DrawMeshInstanced')
            ...
            integer(c_int),      intent(in), value :: instances
        ...
        subroutine draw_rectangle_rounded(rec, roundness, segments, color) bind(c, name='DrawRectangleRounded')
            ...
            implicit none
            type(rectangle_type), intent(in), value :: rec
            real(c_float),        intent(in), value :: roundness
            integer(c_int),       intent(in), value :: segments
            type(color_type),     intent(in), value :: color
        ...
        subroutine draw_ring(center, inner_radius, outer_radius, start_angle, end_angle, segments, color) &
            ...
            implicit none
            type(vector2_type), intent(in), value :: center
            real(c_float),      intent(in), value :: inner_radius
            real(c_float),      intent(in), value :: outer_radius
            real(c_float),      intent(in), value :: start_angle
            real(c_float),      intent(in), value :: end_angle
            integer(c_int),     intent(in), value :: segments
            type(color_type),   intent(in), value :: color
        ...
        subroutine draw_text_codepoints(font, codepoints, codepointCount, position, font_size, spacing, tint) &
            ...
            implicit none
            type(font_type),    intent(in), value :: font
            integer(c_int),     intent(inout)     :: codepoints(*)
            integer(c_int),     intent(in), value :: codepointCount
            type(vector2_type), intent(in), value :: position
            real(c_float),      intent(in), value :: font_size
            real(c_float),      intent(in), value :: spacing
            type(color_type),   intent(in), value :: tint
        ...
        function export_data_as_code(data, data_size, file_name) bind(c, name='ExportDataAsCode')
            ...
            logical(c_bool)                             :: export_data_as_code
        ...
        function export_font_as_code(font, file_name) bind(c, name='ExportFontAsCode')
            ...
            type(font_type),   intent(in), value :: font
            character(c_char), intent(in)        :: file_name
            logical(c_bool)                      :: export_font_as_code
        ...
        function export_image_as_code(image, file_name) bind(c, name='ExportImageAsCode')
            ...
            type(image_type),  intent(in), value :: image
            character(c_char), intent(in)        :: file_name
            logical(c_bool)                      :: export_image_as_code
        ...
        function export_image_to_memory(image, file_type, file_size) bind(c, name='ExportImageToMemory')
            ...
            implicit none
            type(image_type),  intent(in), value :: image
            character(c_char), intent(in)        :: file_type
            integer(c_int),    intent(out)       :: file_size
        ...
        function export_mesh_as_code(mesh, file_name) bind(c, name='ExportMeshAsCode')
            ...
            type(mesh_type),   intent(in), value :: mesh
            character(c_char), intent(in)        :: file_name
            logical(c_bool)                      :: export_mesh_as_code
        ...
        function export_wave_as_code(wave, file_name) bind(c, name='ExportWaveAsCode')
            ...
            type(wave_type),   intent(in), value :: wave
            character(c_char), intent(in)        :: file_name
            logical(c_bool)                      :: export_wave_as_code
        ...
        function file_copy(src_path, dst_path) bind(c, name='FileCopy')
            import :: c_char, c_int
            implicit none
            character(c_char), intent(in) :: src_path
            character(c_char), intent(in) :: dst_path
            integer(c_int)                :: file_copy
        ...
        function file_move(src_path, dst_path) bind(c, name='FileMove')
            import :: c_char, c_int
            implicit none
            character(c_char), intent(in) :: src_path
            character(c_char), intent(in) :: dst_path
            integer(c_int)                :: file_move
        end function file_move

        ! int FileRemove(const char *fileName)
        function file_remove(file_name) bind(c, name='FileRemove')
            import :: c_char, c_int
            implicit none
            character(c_char), intent(in) :: file_name
            integer(c_int)                :: file_remove
        end function file_remove

        ! int FileRename(const char *fileName, const char *fileRename)
        function file_rename(name, rename) bind(c, name='FileRename')
            import :: c_char, c_int
            implicit none
            character(c_char), intent(in) :: name
            character(c_char), intent(in) :: rename
            integer(c_int)                :: file_rename
        end function file_rename

        ! int FileTextFindIndex(const char *fileName, const char *search)
        function file_text_find_index(file_name, search) bind(c, name='FileTextFindIndex')
            import :: c_char, c_int
            implicit none
            character(c_char), intent(in) :: file_name
            character(c_char), intent(in) :: search
            integer(c_int)                :: file_text_find_index
        end function file_text_find_index

        ! int FileTextReplace(const char *fileName, const char *search, const char *replacement)
        function file_text_replace(file_name, search, replacement) bind(c, name='FileTextReplace')
            import :: c_char, c_int
            implicit none
            character(c_char), intent(in) :: file_name
            character(c_char), intent(in) :: search
            character(c_char), intent(in) :: replacement
            integer(c_int)                :: file_text_replace
        end function file_text_replace
        ...
        function gen_image_cellular(width, height, tile_size) bind(c, name='GenImageCellular')
            ...
            integer(c_int), intent(in), value :: width
            integer(c_int), intent(in), value :: height
            integer(c_int), intent(in), value :: tile_size
        ...
        function gen_image_checked(width, height, checks_x, checks_y, col1, col2) bind(c, name='GenImageChecked')
            ...
            integer(c_int),   intent(in), value :: width
            integer(c_int),   intent(in), value :: height
            integer(c_int),   intent(in), value :: checks_x
            integer(c_int),   intent(in), value :: checks_y
            type(color_type), intent(in), value :: col1
            type(color_type), intent(in), value :: col2
        ...
        function gen_image_font_atlas(glyphs, glyph_recs, glyph_count, font_size, padding, pack_method) &
            ...
            integer(c_int),        intent(in), value :: glyph_count
            integer(c_int),        intent(in), value :: font_size
            integer(c_int),        intent(in), value :: padding
            integer(c_int),        intent(in), value :: pack_method
        ...
        function gen_image_gradient_radial(width, height, density, inner, outer) bind(c, name='GenImageGradientRadial')
            ...
            integer(c_int),   intent(in), value :: width
            integer(c_int),   intent(in), value :: height
            real(c_float),    intent(in), value :: density
            type(color_type), intent(in), value :: inner
            type(color_type), intent(in), value :: outer
        ...
        function gen_mesh_knot(radius, size, rad_seg, sides) bind(c, name='GenMeshKnot')
            ...
            real(c_float),  intent(in), value :: radius
            real(c_float),  intent(in), value :: size
            integer(c_int), intent(in), value :: rad_seg
            integer(c_int), intent(in), value :: sides
        ...
        function gen_mesh_plane(width, length, res_x, res_z) bind(c, name='GenMeshPlane')
            ...
            real(c_float),  intent(in), value :: width
            real(c_float),  intent(in), value :: length
            integer(c_int), intent(in), value :: res_x
            integer(c_int), intent(in), value :: res_z
        ...
        function get_application_directory_() bind(c, name='GetApplicationDirectory')
            import :: c_ptr
            implicit none
            type(c_ptr) :: get_application_directory_
        end function get_application_directory_
        ...
        function get_char_pressed() bind(c, name='GetCharPressed')
            import :: c_int
            implicit none
            integer(c_int) :: get_char_pressed
        ...
        function get_clipboard_text_() bind(c, name='GetClipboardText')
            import :: c_ptr
            implicit none
            type(c_ptr) :: get_clipboard_text_
        end function get_clipboard_text_
        ...
        function get_codepoint(text, codepoint_size) bind(c, name='GetCodepoint')
            ...
            implicit none
            character(c_char), intent(in)  :: text
            integer(c_int),    intent(out) :: codepoint_size
            integer(c_int)                 :: get_codepoint
        ...
        function get_codepoint_count(text) bind(c, name='GetCodepointCount')
            ...
            implicit none
            character(c_char), intent(in) :: text
            integer(c_int)                :: get_codepoint_count
        ...
        function get_codepoint_next(text, codepoint_size) bind(c, name='GetCodepointNext')
            ...
            character(c_char), intent(in)  :: text
            integer(c_int),    intent(out) :: codepoint_size
            integer(c_int)                 :: get_codepoint_next
        ...
        function get_codepoint_previous(text, codepoint_size) bind(c, name='GetCodepointPrevious')
            ...
            character(c_char), intent(in)  :: text
            integer(c_int),    intent(out) :: codepoint_size
            integer(c_int)                 :: get_codepoint_previous
        ...
        function get_color(hex_value) bind(c, name='GetColor')
            ...
            implicit none
            integer(c_unsigned), intent(in), value :: hex_value
        ...
        function get_current_monitor() bind(c, name='GetCurrentMonitor')
            import :: c_int
            implicit none
            integer(c_int) :: get_current_monitor
        end function get_current_monitor

        ! unsigned GetDirectoryFileCount(const char *dirPath)
        function get_directory_file_count(dir_path) bind(c, name='GetDirectoryFileCount')
            import :: c_char, c_unsigned
            implicit none
            character(c_char), intent(in) :: dir_path
            integer(c_unsigned)           :: get_directory_file_count
        ...
        function get_directory_file_count_ex(base_path, filter, scan_subdirs) bind(c, name='GetDirectoryFileCountEx')
            import :: c_bool, c_char, c_unsigned
            implicit none
            character(c_char), intent(in)        :: base_path
            character(c_char), intent(in)        :: filter
            logical(c_bool),   intent(in), value :: scan_subdirs
            integer(c_unsigned)                  :: get_directory_file_count_ex
        end function get_directory_file_count_ex

        ! const char *GetDirectoryPath(const char *filePath)
        function get_directory_path_(file_path) bind(c, name='GetDirectoryPath')
            import :: c_char, c_ptr
            implicit none
            character(c_char), intent(in) :: file_path
            type(c_ptr)                   :: get_directory_path_
        end function get_directory_path_

        ! const char *GetFileExtension(const char *fileName)
        function get_file_extension_(file_name) bind(c, name='GetFileExtension')
            import :: c_char, c_ptr
            implicit none
            character(c_char), intent(in) :: file_name
            type(c_ptr)                   :: get_file_extension_
        end function get_file_extension_
        ...
        function get_file_mod_time(file_name) bind(c, name='GetFileModTime')
            ...
            implicit none
            character(c_char), intent(in) :: file_name
            integer(c_long)               :: get_file_mod_time
        end function get_file_mod_time

        ! const char *GetFileName(const char *filePath)
        function get_file_name_(file_path) bind(c, name='GetFileName')
            import :: c_char, c_ptr
            implicit none
            character(c_char), intent(in) :: file_path
            type(c_ptr)                   :: get_file_name_
        end function get_file_name_

        ! const char *GetFileNameWithoutExt(const char *filePath)
        function get_file_name_without_ext_(file_path) bind(c, name='GetFileNameWithoutExt')
            import :: c_char, c_ptr
            implicit none
            character(c_char), intent(in) :: file_path
            type(c_ptr)                   :: get_file_name_without_ext_
        end function get_file_name_without_ext_
        ...
        function get_gamepad_axis_count(gamepad) bind(c, name='GetGamepadAxisCount')
            import :: c_int
            implicit none
            integer(c_int), intent(in), value :: gamepad
            integer(c_int)                    :: get_gamepad_axis_count
        ...
        function get_gamepad_axis_movement(gamepad, axis) bind(c, name='GetGamepadAxisMovement')
            ...
            real(c_float)                     :: get_gamepad_axis_movement
        ...
        function get_gamepad_button_pressed() bind(c, name='GetGamepadButtonPressed')
            import :: c_int
            implicit none
            integer(c_int) :: get_gamepad_button_pressed
        end function get_gamepad_button_pressed

        ! const char *GetGamepadName(int gamepad)
        function get_gamepad_name_(gamepad) bind(c, name='GetGamepadName')
            import :: c_char, c_int, c_ptr
            implicit none
            integer(c_int), intent(in), value :: gamepad
            type(c_ptr)                       :: get_gamepad_name_
        end function get_gamepad_name_

        ! int GetGestureDetected(void)
        function get_gesture_detected() bind(c, name='GetGestureDetected')
            import :: c_int
            implicit none
            integer(c_int) :: get_gesture_detected
        ...
        function get_gesture_drag_angle() bind(c, name='GetGestureDragAngle')
            import :: c_float
            implicit none
            real(c_float) :: get_gesture_drag_angle
        ...
        function get_gesture_hold_duration() bind(c, name='GetGestureHoldDuration')
            import :: c_float
            implicit none
            real(c_float) :: get_gesture_hold_duration
        ...
        function get_gesture_pinch_angle() bind(c, name='GetGesturePinchAngle')
            import :: c_float
            implicit none
            real(c_float) :: get_gesture_pinch_angle
        ...
        function get_key_name_(key) bind(c, name='GetKeyName')
            import :: c_int, c_ptr
            implicit none
            integer(c_int), intent(in), value :: key
            type(c_ptr)                       :: get_key_name_
        end function get_key_name_

        ! int GetKeyPressed(void)
        function get_key_pressed() bind(c, name='GetKeyPressed')
            import :: c_int
            implicit none
            integer(c_int) :: get_key_pressed
        ...
        function get_master_volume() bind(c, name='GetMasterVolume')
            import :: c_float
            implicit none
            real(c_float) :: get_master_volume
        ...
        function get_monitor_count() bind(c, name='GetMonitorCount')
            import :: c_int
            implicit none
            integer(c_int) :: get_monitor_count
        ...
        function get_monitor_height(monitor) bind(c, name='GetMonitorHeight')
            ...
            integer(c_int)                    :: get_monitor_height
        end function get_monitor_height

        ! const char *GetMonitorName(int monitor)
        function get_monitor_name_(monitor) bind(c, name='GetMonitorName')
            import :: c_int, c_ptr
            implicit none
            integer(c_int), intent(in), value :: monitor
            type(c_ptr)                       :: get_monitor_name_
        end function get_monitor_name_
        ...
        function get_monitor_physical_height(monitor) bind(c, name='GetMonitorPhysicalHeight')
            ...
            implicit none
            integer(c_int), intent(in), value :: monitor
            integer(c_int)                    :: get_monitor_physical_height
        ...
        function get_monitor_physical_width(monitor) bind(c, name='GetMonitorPhysicalWidth')
            ...
            implicit none
            integer(c_int), intent(in), value :: monitor
            integer(c_int)                    :: get_monitor_physical_width
        ...
        function get_monitor_refresh_rate(monitor) bind(c, name='GetMonitorRefreshRate')
            ...
            implicit none
            integer(c_int), intent(in), value :: monitor
            integer(c_int)                    :: get_monitor_refresh_rate
        ...
        function get_monitor_width(monitor) bind(c, name='GetMonitorWidth')
            ...
            implicit none
            integer(c_int), intent(in), value :: monitor
            integer(c_int)                    :: get_monitor_width
        ...
        function get_mouse_wheel_move() bind(c, name='GetMouseWheelMove')
            import :: c_float
            implicit none
            real(c_float) :: get_mouse_wheel_move
        ...
        function get_music_time_length(music) bind(c, name='GetMusicTimeLength')
            ...
            real(c_float)                       :: get_music_time_length
        ...
        function get_music_time_played(music) bind(c, name='GetMusicTimePlayed')
            ...
            implicit none
            type(music_type), intent(in), value :: music
            real(c_float)                       :: get_music_time_played
        ...
        function get_pixel_data_size(width, height, format) bind(c, name='GetPixelDataSize')
            ...
            integer(c_int), intent(in), value :: height
            integer(c_int), intent(in), value :: format
            integer(c_int)                    :: get_pixel_data_size
        end function get_pixel_data_size

        ! const char *GetPrevDirectoryPath(const char *dirPath)
        function get_prev_directory_path_(dir_path) bind(c, name='GetPrevDirectoryPath')
            import :: c_char, c_ptr
            implicit none
            character(c_char), intent(in) :: dir_path
            type(c_ptr)                   :: get_prev_directory_path_
        end function get_prev_directory_path_

        ! int GetRandomValue(int min, int max)
        function get_random_value(min, max) bind(c, name='GetRandomValue')
            import :: c_int
            implicit none
            integer(c_int), intent(in), value :: min
            integer(c_int), intent(in), value :: max
            integer(c_int)                    :: get_random_value
        ...
        function get_render_height() bind(c, name='GetRenderHeight')
            import :: c_int
            implicit none
            integer(c_int) :: get_render_height
        ...
        function get_render_width() bind(c, name='GetRenderWidth')
            import :: c_int
            implicit none
            integer(c_int) :: get_render_width
        ...
        function get_screen_height() bind(c, name='GetScreenHeight')
            import :: c_int
            implicit none
            integer(c_int) :: get_screen_height
        ...
        function get_screen_width() bind(c, name='GetScreenWidth')
            import :: c_int
            implicit none
            integer(c_int) :: get_screen_width
        ...
        function get_shader_location(shader, uniform_name) bind(c, name='GetShaderLocation')
            ...
            implicit none
            type(shader_type), intent(in), value :: shader
            character(c_char), intent(in)        :: uniform_name
            integer(c_int)                       :: get_shader_location
        ...
        function get_shader_location_attrib(shader, attrib_name) bind(c, name='GetShaderLocationAttrib')
            ...
            implicit none
            type(shader_type), intent(in), value :: shader
            character(c_char), intent(in)        :: attrib_name
            integer(c_int)                       :: get_shader_location_attrib
        ...
        function get_spline_point_bezier_quadratic(p1, c2, p3, t) bind(c, name='GetSplinePointBezierQuadratic')
            import :: c_float, vector2_type
            implicit none
            type(vector2_type), intent(in), value :: p1
            type(vector2_type), intent(in), value :: c2
            type(vector2_type), intent(in), value :: p3
            real(c_float),      intent(in), value :: t
            type(vector2_type)                    :: get_spline_point_bezier_quadratic
        end function get_spline_point_bezier_quadratic
        ...
        function get_text_between(text, begin, end) bind(c, name='GetTextBetween')
            import :: c_char, c_ptr
            implicit none
            character(c_char), intent(in) :: text
            character(c_char), intent(in) :: begin
            character(c_char), intent(in) :: end
            type(c_ptr)                   :: get_text_between
        end function get_text_between

        ! double GetTime(void)
        function get_time() bind(c, name='GetTime')
            import :: c_double
            implicit none
            real(c_double) :: get_time
        ...
        function get_touch_point_count() bind(c, name='GetTouchPointCount')
            import :: c_int
            implicit none
            integer(c_int) :: get_touch_point_count
        ...
        function get_touch_point_id(index) bind(c, name='GetTouchPointId')
            ...
            integer(c_int)                    :: get_touch_point_id
        ...
        function get_window_scale_dpi() bind(c, name='GetWindowScaleDPI')
            import :: vector2_type
            implicit none
            type(vector2_type) :: get_window_scale_dpi
        end function get_window_scale_dpi

        ! const char *GetWorkingDirectory(void)
        function get_working_directory_() bind(c, name='GetWorkingDirectory')
            import :: c_ptr
            implicit none
            type(c_ptr) :: get_working_directory_
        end function get_working_directory_
        ...
        subroutine image_blur_gaussian(image, blur_size) bind(c, name='ImageBlurGaussian')
            ...
            implicit none
            type(image_type), intent(inout)     :: image
            integer(c_int),   intent(in), value :: blur_size
        ...
        subroutine image_color_brightness(image, brightness) bind(c, name='ImageColorBrightness')
            ...
            implicit none
            type(image_type), intent(inout)     :: image
            integer(c_int),   intent(in), value :: brightness
        ...
        subroutine image_dither(image, r_bpp, g_bpp, b_bpp, a_bpp) bind(c, name='ImageDither')
            ...
            implicit none
            type(image_type), intent(inout)     :: image
            integer(c_int),   intent(in), value :: r_bpp
            integer(c_int),   intent(in), value :: g_bpp
            integer(c_int),   intent(in), value :: b_bpp
            integer(c_int),   intent(in), value :: a_bpp
        ...
        subroutine image_draw_line_ex(dst, start, end, thick, color) bind(c, name='ImageDrawLineEx')
            ...
            integer(c_int),      intent(in), value :: thick
            type(color_type),    intent(in), value :: color
        ...
        subroutine image_format(image, new_format) bind(c, name='ImageFormat')
            ...
            implicit none
            type(image_type), intent(inout)     :: image
            integer(c_int),   intent(in), value :: new_format
        ...
        function image_from_channel(image, selected_channel) bind(c, name='ImageFromChannel')
            ...
            implicit none
            type(image_type), intent(in), value :: image
            integer(c_int),   intent(in), value :: selected_channel
        ...
        subroutine image_kernel_convolution(image, kernel, kernel_size) bind(c, name='ImageKernelConvolution')
            ...
            implicit none
            type(image_type), intent(inout)     :: image
            real(c_float),    intent(inout)     :: kernel(*)
            integer(c_int),   intent(in), value :: kernel_size
        ...
        subroutine image_resize(image, new_width, new_height) bind(c, name='ImageResize')
            ...
            implicit none
            type(image_type), intent(inout)     :: image
            integer(c_int),   intent(in), value :: new_width
            integer(c_int),   intent(in), value :: new_height
        ...
        subroutine image_rotate(image, degrees) bind(c, name='ImageRotate')
            ...
            implicit none
            type(image_type), intent(inout)     :: image
            integer(c_int),   intent(in), value :: degrees
        ...
        function is_audio_device_ready() bind(c, name='IsAudioDeviceReady')
            import :: c_bool
            implicit none
            logical(c_bool) :: is_audio_device_ready
        ...
        function is_audio_stream_playing(stream) bind(c, name='IsAudioStreamPlaying')
            ...
            implicit none
            type(audio_stream_type), intent(in), value :: stream
            logical(c_bool)                            :: is_audio_stream_playing
        ...
        function is_audio_stream_processed(stream) bind(c, name='IsAudioStreamProcessed')
            ...
            implicit none
            type(audio_stream_type), intent(in), value :: stream
            logical(c_bool)                            :: is_audio_stream_processed
        ...
        function is_audio_stream_ready(stream) bind(c, name='IsAudioStreamReady')
            ...
            implicit none
            type(audio_stream_type), intent(in), value :: stream
            logical(c_bool)                            :: is_audio_stream_ready
        ...
        function is_cursor_hidden() bind(c, name='IsCursorHidden')
            import :: c_bool
            implicit none
            logical(c_bool) :: is_cursor_hidden
        ...
        function is_cursor_on_screen() bind(c, name='IsCursorOnScreen')
            import :: c_bool
            implicit none
            logical(c_bool) :: is_cursor_on_screen
        ...
        function is_file_dropped() bind(c, name='IsFileDropped')
            import :: c_bool
            implicit none
            logical(c_bool) :: is_file_dropped
        ...
        function is_file_extension(file_name, ext) bind(c, name='IsFileExtension')
            ...
            logical(c_bool)               :: is_file_extension
        ...
        function is_file_name_valid(file_name) bind(c, name='IsFileNameValid')
            ...
            implicit none
            character(c_char), intent(in) :: file_name
            logical(c_bool)               :: is_file_name_valid
        ...
        function is_gamepad_available(gamepad) bind(c, name='IsGamepadAvailable')
            ...
            implicit none
            integer(c_int), intent(in), value :: gamepad
            logical(c_bool)                   :: is_gamepad_available
        ...
        function is_gamepad_button_down(gamepad, button) bind(c, name='IsGamepadButtonDown')
            ...
            logical(c_bool)                   :: is_gamepad_button_down
        ...
        function is_gamepad_button_pressed(gamepad, button) bind(c, name='IsGamepadButtonPressed')
            ...
            integer(c_int), intent(in), value :: gamepad
            integer(c_int), intent(in), value :: button
            logical(c_bool)                   :: is_gamepad_button_pressed
        ...
        function is_gamepad_button_released(gamepad, button) bind(c, name='IsGamepadButtonReleased')
            ...
            integer(c_int), intent(in), value :: gamepad
            integer(c_int), intent(in), value :: button
            logical(c_bool)                   :: is_gamepad_button_released
        ...
        function is_gamepad_button_up(gamepad, button) bind(c, name='IsGamepadButtonUp')
            ...
            integer(c_int), intent(in), value :: gamepad
            integer(c_int), intent(in), value :: button
            logical(c_bool)                   :: is_gamepad_button_up
        ...
        function is_gesture_detected(gesture) bind(c, name='IsGestureDetected')
            ...
            implicit none
            integer(c_unsigned), intent(in), value :: gesture
            logical(c_bool)                        :: is_gesture_detected
        ...
        function is_key_pressed_repeat(key) bind(c, name='IsKeyPressedRepeat')
            ...
            implicit none
            integer(c_int), intent(in), value :: key
            logical(c_bool)                   :: is_key_pressed_repeat
        ...
        function is_key_released(key) bind(c, name='IsKeyReleased')
            ...
            implicit none
            integer(c_int), intent(in), value :: key
            logical(c_bool)                   :: is_key_released
        ...
        function is_material_ready(material) bind(c, name='IsMaterialReady')
            ...
            implicit none
            type(material_type), intent(in), value :: material
            logical(c_bool)                        :: is_material_ready
        ...
        function is_model_animation_valid(model, anim) bind(c, name='IsModelAnimationValid')
            ...
            logical(c_bool)                               :: is_model_animation_valid
        ...
        function is_mouse_button_down(button) bind(c, name='IsMouseButtonDown')
            ...
            implicit none
            integer(c_int), intent(in), value :: button
            logical(c_bool)                   :: is_mouse_button_down
        ...
        function is_mouse_button_pressed(button) bind(c, name='IsMouseButtonPressed')
            ...
            implicit none
            integer(c_int), intent(in), value :: button
            logical(c_bool)                   :: is_mouse_button_pressed
        ...
        function is_mouse_button_released(button) bind(c, name='IsMouseButtonReleased')
            ...
            implicit none
            integer(c_int), intent(in), value :: button
            logical(c_bool)                   :: is_mouse_button_released
        ...
        function is_mouse_button_up(button) bind(c, name='IsMouseButtonUp')
            ...
            implicit none
            integer(c_int), intent(in), value :: button
            logical(c_bool)                   :: is_mouse_button_up
        ...
        function is_music_stream_playing(music) bind(c, name='IsMusicStreamPlaying')
            ...
            implicit none
            type(music_type), intent(in), value :: music
            logical(c_bool)                     :: is_music_stream_playing
        ...
        function is_render_texture_ready(target) bind(c, name='IsRenderTextureReady')
            ...
            implicit none
            type(render_texture2d_type), intent(in), value :: target
            logical(c_bool)                                :: is_render_texture_ready
        ...
        function is_shader_ready(shader) bind(c, name='IsShaderReady')
            ...
            implicit none
            type(shader_type), intent(in), value :: shader
            logical(c_bool)                      :: is_shader_ready
        ...
        function is_sound_playing(sound) bind(c, name='IsSoundPlaying')
            ...
            logical(c_bool)                     :: is_sound_playing
        ...
        function is_texture_ready(texture) bind(c, name='IsTextureReady')
            ...
            implicit none
            type(texture2d_type), intent(in), value :: texture
            logical(c_bool)                         :: is_texture_ready
        ...
        function is_window_focused() bind(c, name='IsWindowFocused')
            import :: c_bool
            implicit none
            logical(c_bool) :: is_window_focused
        ...
        function is_window_fullscreen() bind(c, name='IsWindowFullscreen')
            import :: c_bool
            implicit none
            logical(c_bool) :: is_window_fullscreen
        ...
        function is_window_hidden() bind(c, name='IsWindowHidden')
            import :: c_bool
            implicit none
            logical(c_bool) :: is_window_hidden
        ...
        function is_window_maximized() bind(c, name='IsWindowMaximized')
            import :: c_bool
            implicit none
            logical(c_bool) :: is_window_maximized
        ...
        function is_window_minimized() bind(c, name='IsWindowMinimized')
            import :: c_bool
            implicit none
            logical(c_bool) :: is_window_minimized
        ...
        function is_window_ready() bind(c, name='IsWindowReady')
            import :: c_bool
            implicit none
            logical(c_bool) :: is_window_ready
        ...
        function is_window_resized() bind(c, name='IsWindowResized')
            import :: c_bool
            implicit none
            logical(c_bool) :: is_window_resized
        ...
        function is_window_state(flag) bind(c, name='IsWindowState')
            import :: c_bool, c_unsigned
            implicit none
            integer(c_unsigned), intent(in), value :: flag
            logical(c_bool)                        :: is_window_state
        ...
        function load_audio_stream(sample_rate, sample_size, channels) bind(c, name='LoadAudioStream')
            ...
            implicit none
            integer(c_unsigned), intent(in), value :: sample_rate
            integer(c_unsigned), intent(in), value :: sample_size
            integer(c_unsigned), intent(in), value :: channels
        ...
        function load_font_data(file_data, data_size, font_size, codepoints, codepoints_count, type, glyph_count) &
                bind(c, name='LoadFontData')
            import :: c_char, c_int, c_ptr, glyph_info_type
            implicit none
            character(c_char), intent(in)        :: file_data
            integer(c_int),    intent(in), value :: data_size
            integer(c_int),    intent(in), value :: font_size
            integer(c_int),    intent(inout)     :: codepoints(*)
            integer(c_int),    intent(in), value :: codepoints_count
            integer(c_int),    intent(in), value :: type
            integer(c_int),    intent(out)       :: glyph_count
        ...
        function load_font_from_image(image, key, first_char) bind(c, name='LoadFontFromImage')
            ...
            integer(c_int),   intent(in), value :: first_char
        ...
        function load_image_anim(file_name, frames) bind(c, name='LoadImageAnim')
            ...
            implicit none
            character(c_char), intent(in)  :: file_name
            integer(c_int),    intent(out) :: frames
        ...
        function load_image_palette(image, max_palette_size, color_count) bind(c, name='LoadImagePalette')
            ...
            implicit none
            type(image_type), intent(in), value :: image
            integer(c_int),   intent(in), value :: max_palette_size
            integer(c_int),   intent(out)       :: color_count
        ...
        function load_image_svg(file_name_or_string, width, height) bind(c, name='LoadImageSvg')
            import :: c_char, c_int, image_type
            implicit none
            character(c_char), intent(in)        :: file_name_or_string
            integer(c_int),    intent(in), value :: width
            integer(c_int),    intent(in), value :: height
        ...
        function load_materials(file_name, material_count) bind(c, name='LoadMaterials')
            ...
            implicit none
            character(c_char), intent(in)  :: file_name
            integer(c_int),    intent(out) :: material_count
        ...
        function load_model_animations(file_name, anim_count) bind(c, name='LoadModelAnimations')
            ...
            implicit none
            character(c_char), intent(in)  :: file_name
            integer(c_int),    intent(out) :: anim_count
        ...
        function load_random_sequence(count, min, max) bind(c, name='LoadRandomSequence')
            ...
            implicit none
            integer(c_unsigned), intent(in), value :: count
            integer(c_int),      intent(in), value :: min
            integer(c_int),      intent(in), value :: max
        ...
        function load_shader(vs_file_name, fs_file_name) bind(c, name='LoadShader')
            ...
            implicit none
            character(c_char), intent(in) :: vs_file_name
            character(c_char), intent(in) :: fs_file_name
        ...
        function load_shader_from_memory(vs_code, fs_code) bind(c, name='LoadShaderFromMemory')
            import :: c_char, shader_type
            implicit none
            character(c_char), intent(in) :: vs_code
            character(c_char), intent(in) :: fs_code
        ...
        function load_text_lines(text, count) bind(c, name='LoadTextLines')
            import :: c_char, c_int, c_ptr
            implicit none
            character(c_char), intent(in)  :: text
            integer(c_int),    intent(out) :: count
            type(c_ptr)                    :: load_text_lines
        end function load_text_lines
        ...
        function load_utf8(codepoints, length) bind(c, name='LoadUTF8')
            import :: c_int, c_ptr
            implicit none
            integer(c_int), intent(out)       :: codepoints(*)
        ...
        function measure_text_codepoints(font, codepoints, length, font_size, spacing) bind(c, name='MeasureTextCodepoints')
            import :: c_float, c_int, font_type, vector2_type
            implicit none
            type(font_type), intent(in), value :: font
            integer(c_int),  intent(in)        :: codepoints(*)
            integer(c_int),  intent(in), value :: length
            real(c_float),   intent(in), value :: font_size
            real(c_float),   intent(in), value :: spacing
            type(vector2_type)                 :: measure_text_codepoints
        end function measure_text_codepoints
        ...
        function mem_alloc(size) bind(c, name='MemAlloc')
            import :: c_ptr, c_unsigned
            implicit none
            integer(c_unsigned), intent(in), value :: size
        ...
        subroutine seek_music_stream(music, position) bind(c, name='SeekMusicStream')
            ...
            implicit none
            type(music_type), intent(in), value :: music
            real(c_float),    intent(in), value :: position
        ...
        subroutine set_audio_stream_pan(stream, pan) bind(c, name='SetAudioStreamPan')
            ...
            implicit none
            type(audio_stream_type), intent(in), value :: stream
            real(c_float),           intent(in), value :: pan
        ...
        subroutine set_camera_alt_control(key_alt) bind(c, name='SetCameraAltControl')
            import :: c_int
            implicit none
            integer(c_int), intent(in), value :: key_alt
        ...
        subroutine set_camera_move_controls(key_front, key_back, key_right, key_left, key_up, key_down) &
            ...
            import :: c_int
            implicit none
            integer(c_int), intent(in), value :: key_front
            integer(c_int), intent(in), value :: key_back
            integer(c_int), intent(in), value :: key_right
            integer(c_int), intent(in), value :: key_left
            integer(c_int), intent(in), value :: key_up
            integer(c_int), intent(in), value :: key_down
        ...
        subroutine set_camera_pan_control(key_pan) bind(c, name='SetCameraPanControl')
            import :: c_int
            implicit none
            integer(c_int), intent(in), value :: key_pan
        ...
        subroutine set_camera_smooth_zoom_control(key_smooth_zoom) bind(c, name='SetCameraSmoothZoomControl')
            import :: c_int
            implicit none
            integer(c_int), intent(in), value :: key_smooth_zoom
        ...
        function set_gamepad_mappings(mappings) bind(c, name='SetGamepadMappings')
            import :: c_char, c_int
            implicit none
            character(c_char), intent(in) :: mappings
            integer(c_int)                :: set_gamepad_mappings
        ...
        subroutine set_material_texture(material, map_type, texture) bind(c, name='SetMaterialTexture')
            ...
            integer(c_int),       intent(in), value :: map_type
            type(texture2d_type), intent(in), value :: texture
        ...
        subroutine set_model_mesh_material(model, mesh_id, material_id) bind(c, name='SetModelMeshMaterial')
            ...
            integer(c_int),   intent(in), value :: mesh_id
            integer(c_int),   intent(in), value :: material_id
        ...
        subroutine set_mouse_cursor(cursor) bind(c, name='SetMouseCursor')
            import :: c_int
            implicit none
            integer(c_int), intent(in), value :: cursor
        ...
        subroutine set_random_seed(seed) bind(c, name='SetRandomSeed')
            import :: c_unsigned
            implicit none
            integer(c_unsigned), intent(in), value :: seed
        ...
        subroutine set_shader_value(shader, loc_index, value, uniform_type) bind(c, name='SetShaderValue')
            ...
            implicit none
            type(shader_type), intent(in), value :: shader
            integer(c_int),    intent(in), value :: loc_index
            type(c_ptr),       intent(in), value :: value
            integer(c_int),    intent(in), value :: uniform_type
        ...
        subroutine set_text_line_spacing(spacing) bind(c, name='SetTextLineSpacing')
            import :: c_int
            implicit none
            integer(c_int), intent(in), value :: spacing
        ...
        subroutine set_texture_filter(texture, filter) bind(c, name='SetTextureFilter')
            ...
            implicit none
            type(texture2d_type), intent(in), value :: texture
            integer(c_int),       intent(in), value :: filter
        ...
        subroutine set_texture_wrap(texture, wrap) bind(c, name='SetTextureWrap')
            ...
            implicit none
            type(texture2d_type), intent(in), value :: texture
            integer(c_int),       intent(in), value :: wrap
        ...
        subroutine text_append(text, append, position) bind(c, name='TextAppend')
            ...
            implicit none
            character(c_char), intent(in) :: text
            character(c_char), intent(in) :: append
        ...
        function text_copy(dst, src) bind(c, name='TextCopy')
            import :: c_char, c_int
            implicit none
            character(c_char), intent(in) :: dst
            character(c_char), intent(in) :: src
            integer(c_int)                :: text_copy
        ...
        function text_find_index(text, find) bind(c, name='TextFindIndex')
            ...
            implicit none
            character(c_char), intent(in) :: text
            character(c_char), intent(in) :: find
            integer(c_int)                :: text_find_index
        ...
        function text_insert(text, insert, position) bind(c, name='TextInsert')
            ...
            implicit none
            character(c_char), intent(in)        :: text
            character(c_char), intent(in)        :: insert
            integer(c_int),    intent(in), value :: position
            type(c_ptr)                          :: text_insert
        end function text_insert

        ! char *TextInsertAlloc(const char *text, const char *insert, int position)
        function text_insert_alloc(text, insert, position) bind(c, name='TextInsertAlloc')
            import :: c_char, c_int, c_ptr
            implicit none
            character(c_char), intent(in)        :: text
            character(c_char), intent(in)        :: insert
            integer(c_int),    intent(in), value :: position
            type(c_ptr)                          :: text_insert_alloc
        end function text_insert_alloc

        ! bool TextIsEqual(const char *text1, const char *text2)
        function text_is_equal(text1, text2) bind(c, name='TextIsEqual')
            import :: c_bool, c_char
            implicit none
            character(c_char), intent(in) :: text1
            character(c_char), intent(in) :: text2
            logical(c_bool)               :: text_is_equal
        ...
        function text_length(text) bind(c, name='TextLength')
            ...
            implicit none
            character(c_char), intent(in) :: text
            integer(c_unsigned)           :: text_length
        end function text_length

        ! const char *TextRemoveSpaces(const char *text)
        function text_remove_spaces_(text) bind(c, name='TextRemoveSpaces')
            import :: c_char, c_ptr
            implicit none
            character(c_char), intent(in) :: text
            type(c_ptr)                   :: text_remove_spaces_
        end function text_remove_spaces_
        ...
        function text_replace(text, replace, by) bind(c, name='TextReplace')
            ...
            implicit none
            character(c_char), intent(in) :: text
            character(c_char), intent(in) :: replace
            character(c_char), intent(in) :: by
        ...
        function text_replace_alloc(text, search, replacement) bind(c, name='TextReplaceAlloc')
            import :: c_char, c_ptr
            implicit none
            character(c_char), intent(in) :: text
            character(c_char), intent(in) :: search
            character(c_char), intent(in) :: replacement
            type(c_ptr)                   :: text_replace_alloc
        end function text_replace_alloc

        ! char *TextReplaceBetween(const char *text, const char *begin, const char *end, const char *replacement)
        function text_replace_between(text, begin, end, replacement) bind(c, name='TextReplaceBetween')
            import :: c_char, c_ptr
            implicit none
            character(c_char), intent(in) :: text
            character(c_char), intent(in) :: begin
            character(c_char), intent(in) :: end
            character(c_char), intent(in) :: replacement
            type(c_ptr)                   :: text_replace_between
        end function text_replace_between

        ! char *TextReplaceBetweenAlloc(const char *text, const char *begin, const char *end, const char *replacement)
        function text_replace_between_alloc(text, begin, end, replacement) bind(c, name='TextReplaceBetweenAlloc')
            import :: c_char, c_ptr
            implicit none
            character(c_char), intent(in) :: text
            character(c_char), intent(in) :: begin
            character(c_char), intent(in) :: end
            character(c_char), intent(in) :: replacement
            type(c_ptr)                   :: text_replace_between_alloc
        end function text_replace_between_alloc
        ...
        function text_split(text, delimiter, count) bind(c, name='TextSplit')
            ...
            implicit none
            character(c_char), intent(in)        :: text
            character(c_char), intent(in), value :: delimiter
            integer(c_int),    intent(out)       :: count
            type(c_ptr)                          :: text_split
        end function text_split

        ! const char *TextSubtext(const char *text, int position, int length)
        function text_subtext_(text, position, length) bind(c, name='TextSubtext')
            import :: c_char, c_int, c_ptr
            implicit none
            character(c_char), intent(in)        :: text
            integer(c_int),    intent(in), value :: position
            integer(c_int),    intent(in), value :: length
            type(c_ptr)                          :: text_subtext_
        end function text_subtext_

        ! const char *TextToCamel(const char *text)
        function text_to_camel_(text) bind(c, name='TextToCamel')
            import :: c_char, c_ptr
            implicit none
            character(c_char), intent(in) :: text
            type(c_ptr)                   :: text_to_camel_
        end function text_to_camel_
        ...
        function text_to_integer(text) bind(c, name='TextToInteger')
            ...
            implicit none
            character(c_char), intent(in) :: text
            integer(c_int)                :: text_to_integer
        end function text_to_integer

        ! const char *TextToLower(const char *text)
        function text_to_lower_(text) bind(c, name='TextToLower')
            import :: c_char, c_ptr
            implicit none
            character(c_char), intent(in) :: text
            type(c_ptr)                   :: text_to_lower_
        end function text_to_lower_

        ! const char *TextToPascal(const char *text)
        function text_to_pascal_(text) bind(c, name='TextToPascal')
            import :: c_char, c_ptr
            implicit none
            character(c_char), intent(in) :: text
            type(c_ptr)                   :: text_to_pascal_
        end function text_to_pascal_

        ! const char *TextToSnake(const char *text)
        function text_to_snake_(text) bind(c, name='TextToSnake')
            import :: c_char, c_ptr
            implicit none
            character(c_char), intent(in) :: text
            type(c_ptr)                   :: text_to_snake_
        end function text_to_snake_

        ! const char *TextToUpper(const char *text)
        function text_to_upper_(text) bind(c, name='TextToUpper')
            import :: c_char, c_ptr
            implicit none
            character(c_char), intent(in) :: text
            type(c_ptr)                   :: text_to_upper_
        end function text_to_upper_
        ...
        subroutine unload_random_sequence(sequence) bind(c, name='UnloadRandomSequence')
            import :: c_int
            implicit none
            integer(c_int), intent(inout) :: sequence(*)
        ...
        subroutine unload_text_lines(text, line_count) bind(c, name='UnloadTextLines')
            import :: c_int, c_ptr
            implicit none
            type(c_ptr),    intent(in), value :: text
            integer(c_int), intent(in), value :: line_count
        end subroutine unload_text_lines
        ...
        subroutine unload_wave_samples(samples) bind(c, name='UnloadWaveSamples')
            import :: c_float
            implicit none
            real(c_float), intent(inout) :: samples(*)
        ...
        subroutine upload_mesh(mesh, dynamic) bind(c, name='UploadMesh')
            ...
            logical(c_bool), intent(in), value :: dynamic
        ...
        subroutine wait_time(seconds) bind(c, name='WaitTime')
            import :: c_double
            implicit none
            real(c_double), intent(in), value :: seconds
        ...
        subroutine wave_crop(wave, init_sample, final_sample) bind(c, name='WaveCrop')
            ...
            integer(c_int),  intent(in), value :: init_sample
            integer(c_int),  intent(in), value :: final_sample
        ...
        subroutine wave_format(wave, sample_rate, sample_size, channels) bind(c, name='WaveFormat')
            ...
            implicit none
            type(wave_type), intent(in)        :: wave
            integer(c_int),  intent(in), value :: sample_rate
            integer(c_int),  intent(in), value :: sample_size
            integer(c_int),  intent(in), value :: channels
        ...
        function window_should_close() bind(c, name='WindowShouldClose')
            import :: c_bool
            implicit none
            logical(c_bool) :: window_should_close
...
contains
    ...
    ! **************************************************************************
    ! const char *CodepointToUTF8(int codepoint, int *utf8Size)
    function codepoint_to_utf8(codepoint, utf8_size) result(str)
        integer, intent(in)       :: codepoint
        integer, intent(out)      :: utf8_size
        character(:), allocatable :: str

        type(c_ptr) :: ptr

        ptr = codepoint_to_utf8_(codepoint, utf8_size)
        call c_f_str_ptr(ptr, str)
    end function codepoint_to_utf8

    ! const char *GetApplicationDirectory(void)
    function get_application_directory() result(str)
        character(:), allocatable :: str

        type(c_ptr) :: ptr

        ptr = get_application_directory_()
        call c_f_str_ptr(ptr, str)
    end function get_application_directory

    ! const char *GetClipboardText(void)
    function get_clipboard_text() result(str)
        character(:), allocatable :: str

        type(c_ptr) :: ptr

        ptr = get_clipboard_text_()
        call c_f_str_ptr(ptr, str)
    end function get_clipboard_text

    ! const char *GetDirectoryPath(const char *filePath)
    function get_directory_path(file_path) result(str)
        character(*), intent(in)  :: file_path
        character(:), allocatable :: str

        type(c_ptr) :: ptr

        ptr = get_directory_path_(file_path)
        call c_f_str_ptr(ptr, str)
    end function get_directory_path

    ! const char *GetFileExtension(const char *fileName)
    function get_file_extension(file_name) result(str)
        character(*), intent(in)  :: file_name
        character(:), allocatable :: str

        type(c_ptr) :: ptr

        ptr = get_file_extension_(file_name)
        call c_f_str_ptr(ptr, str)
    end function get_file_extension

    ! const char *GetFileName(const char *filePath)
    function get_file_name(file_path) result(str)
        character(*), intent(in)  :: file_path
        character(:), allocatable :: str

        type(c_ptr) :: ptr

        ptr = get_file_name_(file_path)
        call c_f_str_ptr(ptr, str)
    end function get_file_name

    ! const char *GetFileNameWithoutExt(const char *filePath)
    function get_file_name_without_ext(file_path) result(str)
        character(*), intent(in)  :: file_path
        character(:), allocatable :: str

        type(c_ptr) :: ptr

        ptr = get_file_name_without_ext_(file_path)
        call c_f_str_ptr(ptr, str)
    end function get_file_name_without_ext

    ! const char *GetGamepadName(int gamepad)
    function get_gamepad_name(gamepad) result(str)
        integer, intent(in)       :: gamepad
        character(:), allocatable :: str

        type(c_ptr) :: ptr

        ptr = get_gamepad_name_(gamepad)
        call c_f_str_ptr(ptr, str)
    end function get_gamepad_name

    ! const char *GetKeyName(int key)
    function get_key_name(key) result(str)
        integer, intent(in)       :: key
        character(:), allocatable :: str

        type(c_ptr) :: ptr

        ptr = get_key_name_(key)
        call c_f_str_ptr(ptr, str)
    end function get_key_name

    ! const char *GetMonitorName(int monitor)
    function get_monitor_name(monitor) result(str)
        integer, intent(in)       :: monitor
        character(:), allocatable :: str

        type(c_ptr) :: ptr

        ptr = get_monitor_name_(monitor)
        call c_f_str_ptr(ptr, str)
    end function get_monitor_name

    ! const char *GetPrevDirectoryPath(const char *dirPath)
    function get_prev_directory_path(dir_path) result(str)
        character(*), intent(in)  :: dir_path
        character(:), allocatable :: str

        type(c_ptr) :: ptr

        ptr = get_prev_directory_path_(dir_path)
        call c_f_str_ptr(ptr, str)
    end function get_prev_directory_path

    ! const char *GetWorkingDirectory(void)
    function get_working_directory() result(str)
        character(:), allocatable :: str

        type(c_ptr) :: ptr

        ptr = get_working_directory_()
        call c_f_str_ptr(ptr, str)
    end function get_working_directory

    ! const char *TextRemoveSpaces(const char *text)
    function text_remove_spaces(text) result(str)
        character(*), intent(in)  :: text
        character(:), allocatable :: str

        type(c_ptr) :: ptr

        ptr = text_remove_spaces_(text)
        call c_f_str_ptr(ptr, str)
    end function text_remove_spaces

    ! const char *TextSubtext(const char *text, int position, int length)
    function text_subtext(text, position, length) result(str)
        character(*), intent(in)  :: text
        ...
        ptr = text_subtext_(text, position, length)
        call c_f_str_ptr(ptr, str)
    end function text_subtext

    ! const char *TextToCamel(const char *text)
    function text_to_camel(text) result(str)
        character(*), intent(in)  :: text
        character(:), allocatable :: str

        type(c_ptr) :: ptr

        ptr = text_to_camel_(text)
        call c_f_str_ptr(ptr, str)
    end function text_to_camel

    ! const char *TextToLower(const char *text)
    function text_to_lower(text) result(str)
        character(*), intent(in)  :: text
        character(:), allocatable :: str

        type(c_ptr) :: ptr

        ptr = text_to_lower_(text)
        call c_f_str_ptr(ptr, str)
    end function text_to_lower

    ! const char *TextToPascal(const char *text)
    function text_to_pascal(text) result(str)
        character(*), intent(in)  :: text
        character(:), allocatable :: str

        type(c_ptr) :: ptr

        ptr = text_to_pascal_(text)
        call c_f_str_ptr(ptr, str)
    end function text_to_pascal

    ! const char *TextToSnake(const char *text)
    function text_to_snake(text) result(str)
        character(*), intent(in)  :: text
        character(:), allocatable :: str

        type(c_ptr) :: ptr

        ptr = text_to_snake_(text)
        call c_f_str_ptr(ptr, str)
    end function text_to_snake

    ! const char *TextToUpper(const char *text)
    function text_to_upper(text) result(str)
        character(*), intent(in)  :: text
        character(:), allocatable :: str

        type(c_ptr) :: ptr

        ptr = text_to_upper_(text)
        call c_f_str_ptr(ptr, str)
